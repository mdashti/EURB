 ...
 * @version   1.0
 * @date      19. March 2008
 * @revision  $Id: Ext.ux.menu.IconMenu.js 828 2010-02-28 15:07:35Z jozo $
 * @license   
...
Ext.extend(Ext.ux.menu.IconMenu, Ext.util.Observable, {
	 ...
	 */
	,style:'width:16px;height:16px;right:0;top:4px;position:absolute;cursor:pointer'
...
//				this.onDestroy();
	...
	,onRender:function() {
		...
		this.icon.on({
			 dblclick:{scope:this, stopEvent:true, fn:function() {
