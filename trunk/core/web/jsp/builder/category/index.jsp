...
<html>
	...
	<body scroll="no" id="docs" style="direction: rtl">
		...
		<script type="text/javascript">
			EURB.ReportCategory = {};
			EURB.ReportCategory.searchAction = 'reportCategorySearch.spy';
			EURB.ReportCategory.storeAction = 'reportCategoryStore.spy';
			EURB.ReportCategory.removeAction = 'reportCategoryRemove.spy';
		</script>
