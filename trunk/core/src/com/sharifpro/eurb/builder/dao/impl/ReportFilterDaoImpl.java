...
public class ReportFilterDaoImpl extends AbstractDAO implements ParameterizedRowMapper<ReportFilter>, ReportFilterDao
{
	...
	public ReportFilterPk insert(ReportFilter dto) throws ReportFilterDaoException
	{
		try{
			...
			jdbcTemplate.update("INSERT INTO " + getTableName() + " ( id, column_mapping_id, report_dataset_id, report_design_id, report_design_version_id, prefix, operator, suffix, operand1, " +
					"operand2, filter_type, operand1_column_id, operand1_column_dataset_id, operand1_column_design_id ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )",
	...
	public void update(ReportFilterPk pk, ReportFilter dto) throws ReportFilterDaoException
	{
		try{
			...
			jdbcTemplate.update("UPDATE " + getTableName() + " SET id = ?, column_mapping_id = ?, report_dataset_id = ?, report_design_id = ?, report_design_version_id = ?, prefix = ?, operator = ?, " +
					"suffix = ?, operand1 = ?, operand2 = ?, filter_type = ?, operand1_column_id = ?, operand1_column_dataset_id = ?, operand1_column_design_id = ? WHERE id = ?",
					...
					dto.getOperand2(),dto.getFilterType(),dto.getOperand1ColumnId(),dto.getOperand1ColumnDatasetId(),dto.getOperand1ColumnDesignId(),pk.getId());
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	public ReportFilter mapRow(ResultSet rs, int row) throws SQLException
	{
		...
		dto.setOperand1ColumnId( new Long( rs.getLong(++i) ) );
		if (rs.wasNull()) {
			dto.setOperand1ColumnId( null );
		}

		dto.setOperand1ColumnDatasetId( new Long( rs.getLong(++i) ) );
		if (rs.wasNull()) {
			dto.setOperand1ColumnDatasetId( null );
		}

		dto.setOperand1ColumnDesignId( new Long( rs.getLong(++i) ) );
		if (rs.wasNull()) {
	...
	{
		try {
			List<ReportFilter> list = jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.id = ?", this,id);
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.report_design_id = ? ORDER BY o.id", this, reportDesignId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.queryForInt(COUNT_QUERY + " WHERE o.report_design_id = ? ", reportDesignId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE p.id = ?", this,id);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand1_column_id = ? AND o.operand1_column_dataset_id = ? AND o.operand1_column_design_id = ?", this,operand1ColumnId,operand1ColumnDatasetId,operand1ColumnDesignId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.column_mapping_id = ? AND o.report_dataset_id = ? AND o.report_design_id = ? AND o.report_design_version_id = ?", this,reportColumnId,reportColumnDatasetId,reportColumnDesignId,reportColumnDesignVersionId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.column_mapping_id = ? ORDER BY o.column_mapping_id", this,reportColumnId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.report_dataset_id = ? ORDER BY o.report_dataset_id", this,reportColumnDatasetId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.report_design_id = ? ORDER BY o.report_design_id", this,reportColumnDesignId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.report_design_version_id = ? ORDER BY o.report_design_version_id", this,reportColumnDesignVersionId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.prefix = ? ORDER BY o.prefix", this,prefix);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.suffix = ? ORDER BY o.suffix", this,suffix);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand1 = ? ORDER BY o.operand1", this,operand1);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand2 = ? ORDER BY o.operand2", this,operand2);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.filter_type = ? ORDER BY o.filter_type", this,filterType);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand1_column_id = ? ORDER BY o.operand1_column_id", this,operand1ColumnId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand1_column_dataset_id = ? ORDER BY o.operand1_column_dataset_id", this,operand1ColumnDatasetId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
	...
	{
		try {
			return jdbcTemplate.query(QUERY_SELECT_PART + " WHERE o.operand1_column_design_id = ? ORDER BY o.operand1_column_design_id", this,operand1ColumnDesignId);
		}
		catch (Exception e) {
			throw new ReportFilterDaoException(PropertyProvider.QUERY_FAILED_MESSAGE, e);
		}
