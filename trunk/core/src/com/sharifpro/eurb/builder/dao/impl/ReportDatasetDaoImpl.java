...
public class ReportDatasetDaoImpl extends AbstractDAO implements ParameterizedRowMapper<ReportDataset>, ReportDatasetDao
{
	...
	{
		jdbcTemplate.update("INSERT INTO " + getTableName() + " ( id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ? )",dto.getId(),dto.getDesignId(),dto.getDesignVersionId(),dto.getTableMappingId(),dto.getBaseReportId(),dto.getBaseReportVersionId(),dto.getDsOrder(),dto.getOperator());
		return dto.createPk();
	}
	...
	public ReportDataset mapRow(ResultSet rs, int row) throws SQLException
	{
		...
		dto.setDsOrder( new Integer( rs.getInt(7) ) );
	...
	{
		try {
			List<ReportDataset> list = jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE id = ? AND design_id = ? AND design_version_id = ?", this,id,designId,designVersionId);
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " ORDER BY id, design_id, design_version_id", this);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE id = ?", this,id);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE base_report_id = ? AND base_report_version_id = ?", this,baseReportId,baseReportVersionId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE design_id = ? AND design_version_id = ?", this,designId,designVersionId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE table_mapping_id = ?", this,tableMappingId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE id = ? ORDER BY id", this,id);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE design_id = ? ORDER BY design_id", this,designId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE design_version_id = ? ORDER BY design_version_id", this,designVersionId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE table_mapping_id = ? ORDER BY table_mapping_id", this,tableMappingId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE base_report_id = ? ORDER BY base_report_id", this,baseReportId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE base_report_version_id = ? ORDER BY base_report_version_id", this,baseReportVersionId);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE ds_order = ? ORDER BY ds_order", this,dsOrder);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
	...
	{
		try {
			return jdbcTemplate.query("SELECT id, design_id, design_version_id, table_mapping_id, base_report_id, base_report_version_id, ds_order, operator FROM " + getTableName() + " WHERE operator = ? ORDER BY operator", this,operator);
		}
		catch (Exception e) {
			throw new ReportDatasetDaoException("Query failed", e);
		}
