...
public class IndexColInfo {
	...
	public int hashCode() {
		...
		result = PRIME
				* result
				+ ((_ordinalPosition == null) ? 0 : _ordinalPosition.hashCode());
		return result;
	}
	...
	public int compareTo(Object obj) {
		return _ordinalPosition
				.compareTo(((IndexColInfo) obj)._ordinalPosition);
	}
	...
	public static class OrdinalPositionComparator implements
			Comparator<IndexColInfo>, Serializable {
		private static final long serialVersionUID = 1L;
