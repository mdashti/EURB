...
/**
 * A simple object to store user preferences regarding contraint info. When we
 * are generating a create script, we want to take into account the user's
 * preferences. However, when showing the source for constraints, we want to
...
public class CreateScriptPreferences {
	...
	/**
	 * @param constraintsAtEnd
	 *            the constraintsAtEnd to set
	 */
	...
	/**
	 * @param includeExternalReferences
	 *            the includeExternalReferences to set
	 */
