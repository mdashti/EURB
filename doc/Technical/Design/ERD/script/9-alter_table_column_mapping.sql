...
ALTER TABLE `eurb`.`column_mapping` 
CHANGE COLUMN `referenced_table` `referenced_table` BIGINT(19) UNSIGNED NULL DEFAULT NULL  , 
CHANGE COLUMN `referenced_id_col` `referenced_id_col` BIGINT(19) UNSIGNED NULL DEFAULT NULL  , 
CHANGE COLUMN `referenced_value_col` `referenced_value_col` BIGINT(19) UNSIGNED NULL DEFAULT NULL  , 
