...
public interface ReportAlertDao
{	
	public ReportUserAlert executeAlert(ReportUserAlert reportAlert, boolean includeReportInLog) throws ReportAlertDaoException;	
	...
	public ReportAlert insertReportAlert(ReportAlert reportAlert)
			throws ReportAlertDaoException;
