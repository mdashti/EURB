 ...
 */
public class FirebirdDialectExt extends CommonHibernateDialect implements
		HibernateDialect {

	private class FirebirdDialectHelper extends
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.CommonHibernateDialect#getPrecisionDigits(int,
	 *      int)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.CommonHibernateDialect#getColumnLength(int,
	 *      int)
	 */
	@Override
	public int getColumnLength(int columnSize, int dataType) {
		if (dataType == Types.BIGINT || dataType == Types.DECIMAL
				|| dataType == Types.DOUBLE || dataType == Types.FLOAT
				|| dataType == Types.NUMERIC || dataType == Types.REAL) {
			return getMaxPrecision(dataType);
		}
		if (dataType == Types.BLOB || dataType == Types.LONGVARBINARY
	...
	public String[] getAddPrimaryKeySQL(String pkName,
		...
		for (int i = 0; i < columns.length; i++) {
			String shapedColumn = DialectUtils.shapeIdentifier(
	...
	public String[] getAddAutoIncrementSQL(TableColumnInfo column,
		...
		String generatorSql = getCreateSequenceSQL(sequenceName,
				incrementNotSupported, minValueNotSupported,
				maxValueNotSupported, startValueNotSupported,
				cacheNotSupported, cycle, qualifier, prefs);

		String triggerName = "CREATE_" + column.getColumnName().toUpperCase();

		String trigTemplate = "CREATE TRIGGER $triggerName$ FOR $tableName$ BEFORE INSERT POSITION 0 AS "
		...
		String trigSql = DialectUtils.bindTemplateAttributes(this, st,
	...
	public String getCreateIndexSQL(String indexName, String tableName,
		...
		return DialectUtils.getAddIndexSQL(this, st, valuesMap, columns,
				qualifier, prefs);
	}
	...
	public String getViewDefinitionSQL(String viewName,
			DatabaseObjectQualifier qualifier, SqlGenerationPreferences prefs) {
		return "select rdb$view_source from rdb$relations where rdb$relation_name = '"
				+ viewName + "'";
	}
