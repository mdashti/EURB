 ...
 */
public class FrontBaseDialectExt extends CommonHibernateDialect implements
		HibernateDialect {

	private class FrontBaseDialectHelper extends
			org.hibernate.dialect.FrontBaseDialect {
		public FrontBaseDialectHelper() {
			super();
			registerColumnType(Types.BIGINT, "longint");
			// I tried to use the length from the source database (PostgreSQL)
			// which
			...
			// Anticipate the same issue for BLOBS as for BINARY and
			// LONGVARBINARY.
			// registerColumnType(Types.BLOB, 2147000000, "bit varying($l)");
			registerColumnType(Types.BLOB, "bit varying(2147000000)");
			// Don't use bit(1) for boolean as Frontbase then reports it as
			// BINARY
			// type instead of BIT.
			...
			//
			// Exception condition 239. Data exception - string data, right
			// truncation.
			// I tried bit varying(32767) with data that had max length of
			// 16384. So
			// it's back to maximum length hard-coded for now.
			// registerColumnType(Types.LONGVARBINARY, 2147000000,
			// "bit varying($l)");
			...
			// Anticipate the same issue for VARBINARY as for BINARY and
			// LONGVARBINARY.
			// registerColumnType(Types.VARBINARY, 2147000000,
			// "bit varying($l)");
	 ...
	 * specified table. alter table tableName drop column columnName cascade
	 * 
	 * @param tableName
	...
	public String getColumnDropSQL(String tableName, String columnName,
		...
		return DialectUtils.getColumnDropSQL(tableName, columnName, dropClause,
				true, "CASCADE", qualifier, prefs, this);
	}
	...
	public List<String> getTableDropSQL(ITableInfo iTableInfo,
		...
		return DialectUtils.getTableDropSQL(iTableInfo, true,
				...
				false, DialectUtils.CASCADE_CLAUSE, false, qualifier, prefs,
				this);
	}
	...
	public String[] getAddPrimaryKeySQL(String pkName,
		...
		return new String[] { DialectUtils.getAddPrimaryKeySQL(ti, pkName,
				columnNames, false, qualifier, prefs, this) };
	}
	...
	/**
	 * Returns the SQL that is used to change the column type. alter column
	 * "test"."foo" to char(11)
	 * 
	 * @param from
	 *            the TableColumnInfo as it is
	 ...
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	// public String getDropIndexSQL(String tableName, String indexName, boolean
	// cascade,
	// DatabaseObjectQualifier qualifier, SqlGenerationPreferences prefs)
	// {
	// return null;
