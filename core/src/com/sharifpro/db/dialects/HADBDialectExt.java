...
/**
 * A dialect delegate for the Sun Microsystems HADB (High-Availability)
 * database. TODO: This dialect is not yet complete. Need to provide
 * implementations wherever "Not yet implemented" appears.
 */
public class HADBDialectExt extends CommonHibernateDialect implements
		HibernateDialect {
	...
	/**
	 * Returns the SQL that is used to change the column name. alter table test
	 * rename column mycol mycol2
	 * 
	 * @param from
