...
/**
 * An extension to the DB2DialectExt. Much of the behavior of DB2 is happily
 * found in Derby.
 */
public class DerbyDialectExt extends DB2DialectExt implements HibernateDialect {
	...
	private static interface i18n {
		...
		// be altered]
		String TYPE_MESSAGE = PropertyProvider.get("DerbyDialect.typeMessage");

		// i18n[DerbyDialect.varcharMessage=Derby only allows varchar columns
		// to be altered]
		String VARCHAR_MESSAGE = PropertyProvider
				.get("DerbyDialect.varcharMessage");

		// i18n[DerbyDialect.columnLengthMessage=Derby only allows varchar
		// column length to be increased]
		String COLUMN_LENGTH_MESSAGE = PropertyProvider
				.get("DerbyDialect.columnLengthMessage");
	}
	...
	private class DerbyDialectHelper extends org.hibernate.dialect.DB2Dialect {
		public DerbyDialectHelper() {
			...
			// Derby is real close to DB2. Only difference I've found so far is
			// 48
			...
			registerColumnType(Types.VARBINARY, 254,
					"long varchar for bit data");
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#canPasteTo(com.sharifpro.db.meta.IDatabaseObjectInfo)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnLength(int,
	 *      int)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getAddColumnSQL(com.sharifpro.db.meta.TableColumnInfo,
	...
	public String[] getAddColumnSQL(final TableColumnInfo column,
		...
		final String sql = DialectUtils.getAddColumSQL(column, this,
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getTableDropSQL(com.sharifpro.db.meta.ITableInfo,
	...
	public String[] getAddPrimaryKeySQL(final String pkName,
			final TableColumnInfo[] colInfos, final ITableInfo ti,
			DatabaseObjectQualifier qualifier, SqlGenerationPreferences prefs) {
		...
		DialectUtils.getMultiColNotNullSQL(colInfos, this, alterClause, false,
				result, qualifier, prefs);

		result.add(DialectUtils.getAddPrimaryKeySQL(ti, pkName, colInfos,
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnCommentAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnNullableAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	@Override
	public String[] getColumnNullableAlterSQL(final TableColumnInfo info,
		...
		return new String[] { DialectUtils.getColumnNullableAlterSQL(info,
				this, alterClause, specifyColumnType, qualifier, prefs) };
	}
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnNameAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	...
	public String getColumnNameAlterSQL(final TableColumnInfo from,
			final TableColumnInfo to, DatabaseObjectQualifier qualifier,
			SqlGenerationPreferences prefs) {
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnTypeAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      com.sharifpro.db.meta.TableColumnInfo,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getColumnDefaultAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      DatabaseObjectQualifier, SqlGenerationPreferences)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getDropSequenceSQL(java.lang.String,
	 *      boolean,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	...
	public String[] getAddUniqueConstraintSQL(String tableName,
		...
		// Derby requires that columns be not-null before applying a unique
		// constraint
		final boolean specifyColumnType = false;
		final String alterClause = DialectUtils.ALTER_COLUMN_CLAUSE;
		for (TableColumnInfo column : columns) {
			if (column.isNullable().equalsIgnoreCase("YES")) {
				columnNotNullAlters.add(DialectUtils.getColumnNullableAlterSQL(
						column, false, this, alterClause, specifyColumnType,
						qualifier, prefs));
			}
		}
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.DB2DialectExt#getViewDefinitionSQL(java.lang.String,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	@Override
	public String getViewDefinitionSQL(String viewName,
		 ...
		 * sys.SYSSCHEMAS s where v.TABLEID = t.TABLEID and s.SCHEMAID =
		 * t.SCHEMAID and UPPER(t.TABLENAME) = 'VIEWNAME' and
		 * UPPER(s.SCHEMANAME) = 'SCHEMANAME'
		 */
