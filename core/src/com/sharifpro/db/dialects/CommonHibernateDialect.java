 ...
 * located, to avoid code duplication and make porting new dialects easier. This
 * class will also be used when connecting to a database for which no other
 * dialect supports.
 * 
 */
public class CommonHibernateDialect implements HibernateDialect,
	...
	public String[] getAddPrimaryKeySQL(String pkName,
		...
		return new String[] { DialectUtils.getAddPrimaryKeySQL(ti, pkName,
				colInfos, false, qualifier, prefs, this) };
	}
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getColumnCommentAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getColumnDefaultAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      DatabaseObjectQualifier, SqlGenerationPreferences)
	 */
	...
	public String getColumnDropSQL(String tableName, String columnName,
		...
		String dropSql = DialectUtils.bindTemplateAttributes(this, st,
				valuesMap, qualifier, prefs);
		return DialectUtils
				.stripQuotesFromIdentifier(this, columnName, dropSql);
	}
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getColumnNameAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getColumnNullableAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getColumnTypeAlterSQL(com.sharifpro.db.meta.TableColumnInfo,
	 *      com.sharifpro.db.meta.TableColumnInfo,
	 *      net.sourceforge.squirrel_sql.fw.dialects.DatabaseObjectQualifier,
	 *      net.sourceforge.squirrel_sql.fw.dialects.SqlGenerationPreferences)
	 */
	...
	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getTableDropSQL(com.sharifpro.db.meta.ITableInfo,
	 *      boolean, boolean, DatabaseObjectQualifier, SqlGenerationPreferences)
	 */
	public List<String> getTableDropSQL(ITableInfo tableInfo,
			boolean cascadeConstraints, boolean isMaterializedView,
			DatabaseObjectQualifier qualifier, SqlGenerationPreferences prefs) {
		return DialectUtils.getTableDropSQL(tableInfo, true,
				cascadeConstraints, false, DialectUtils.CASCADE_CLAUSE, false,
				qualifier, prefs, this);
	}

	/**
	 * @see net.sourceforge.squirrel_sql.fw.dialects.HibernateDialect#getTypeName(com.sharifpro.db.meta.TableColumnInfo)
	 */
	public String getTypeName(TableColumnInfo tcInfo) {
		...
		return getTypeName(dataType, columnSize, precision,
				tcInfo.getDecimalDigits());
	}

	/**
	 * This should be overridden by dialects to provide a mapping between native
	 * column name and java.sql.Types codes. This is particulary helpful for
	 * databases with "other" (1111) types.
	 * 
	...
	public int getJavaTypeForNativeType(String nativeColumnTypeName) {
		throw new IllegalStateException("Dialect (" + getDisplayName()
				+ ") doesn't provide a java type for native type = "
	...
	public String getTypeName(int code, int length, int precision, int scale)
		...
		// TODO Need to have a generic hibernate dialect extend this to provide
		// the types.
	...
	public String getBinaryLiteralString(byte[] binaryData) {
		...
		result.append("'").append(DialectUtils.toHexString(binaryData))
				.append("'");
