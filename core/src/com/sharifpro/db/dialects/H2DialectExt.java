 ...
 */
public class H2DialectExt extends CommonHibernateDialect implements
		HibernateDialect {

	/**
	 * A subclass to allow access to getTypeName without having to extend
	 * Dialect.
	 */
	 ...
	 * specified table composed of the given column names. alter table test
	 * alter column mychar char(10) not null alter table test add primary key
	...
	public String[] getAddPrimaryKeySQL(String pkName,
		...
		addPKSQL.append(DialectUtils.shapeQualifiableIdentifier(
		...
		for (int i = 0; i < columns.length; i++) {
			...
			if (info.isNullable().equals("YES")) {
				...
				String notNullSql = DialectUtils.getColumnNullableAlterSQL(
						info, false, this, alterClause, true, qualifier, prefs);
	 ...
	 * ALTER TABLE tableName ALTER COLUMN columnName dataType [DEFAULT
	 * expression] [NOT [NULL]]
	 * 
	 * @param info
	...
	/**
	 * Returns the SQL that is used to change the column name. ALTER TABLE
	 * tableName ALTER COLUMN columnName RENAME TO name
	 * 
	 * @param from
	 ...
	 * table_name ALTER COLUMN column_name data_type
	 * 
	 * @param from
	 *            the TableColumnInfo as it is
	 * @param to
	...
	public String getColumnDropSQL(String tableName, String columnName,
		...
		HashMap<String, String> valuesMap = DialectUtils.getValuesMap(
				ST_TABLE_NAME_KEY, tableName, ST_COLUMN_NAME_KEY, columnName);
	...
	public String[] getAddUniqueConstraintSQL(String tableName,
		...
		StringTemplate st = new StringTemplate(
				ST_ADD_UNIQUE_CONSTRAINT_STYLE_ONE);

		HashMap<String, String> valuesMap = DialectUtils.getValuesMap(
				ST_TABLE_NAME_KEY, tableName, ST_CONSTRAINT_KEY, "CONSTRAINT",
				ST_CONSTRAINT_NAME_KEY, constraintName);

		return new String[] { DialectUtils.bindTemplateAttributes(this, st,
				valuesMap, columns, qualifier, prefs) };
	...
	public String getRenameTableSQL(String oldTableName, String newTableName,
		...
		HashMap<String, String> valuesMap = DialectUtils.getValuesMap(
				ST_OLD_OBJECT_NAME_KEY, oldTableName, ST_NEW_OBJECT_NAME_KEY,
				newTableName);
	...
	public String[] getRenameViewSQL(String oldViewName, String newViewName,
			DatabaseObjectQualifier qualifier, SqlGenerationPreferences prefs) {
		String msg = DialectUtils.getUnsupportedMessage(this,
				DialectUtils.RENAME_VIEW_TYPE);
	...
	public String getSequenceInformationSQL(String sequenceName,
		...
		// "AND SEQUENCE_NAME = ? ";
		String templateStr = "SELECT CURRENT_VALUE, 'NONE', 'NONE', CACHE, INCREMENT, 0 "
				+ "FROM INFORMATION_SCHEMA.SEQUENCES "
	...
	public String getViewDefinitionSQL(String viewName,
		...
		// "where table_schema = ? " +
		// "and table_name = ? ";
		String templateStr = "select view_definition from information_schema.views "
