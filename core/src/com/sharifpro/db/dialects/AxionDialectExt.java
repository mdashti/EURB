...
/**
 * A dialect delegate for the Axion database. TODO: This dialect is not yet
 * complete. Need to provide implementations wherever "Not yet implemented"
 * appears.
 */

public class AxionDialectExt extends CommonHibernateDialect implements
		HibernateDialect {
	private class AxionDialectHelper extends Dialect {
		public AxionDialectHelper() {
			...
			// Can someone please tell me why Axion expects big integers to be
			// limited
			// to 20 precision and 10 scale?(Integers should have scale == 0,
			// right?)
			// So an Axion bigint is limited to just 20 digits to the left of
			// the
			// decimal point.
			...
			// Don't use "real" type. Axion sets the column size to 12 by
			// default,
			// yet it can handle more precision. So data being copied from the
			// real
			// column can potentially be larger than what the column claims to
			// support.
			// This will be a problem for other databases that pay attention to
			// the
			// column size.
	...
	public List<String> getTableDropSQL(ITableInfo iTableInfo,
		...
		return DialectUtils.getTableDropSQL(iTableInfo, false,
				cascadeConstraints, false, cascadeClause, false, qualifier,
				prefs, this);
	}

	/**
	 * Returns the SQL that forms the command to add a primary key to the
	 * specified table composed of the given column names. alter table tableName
	 * add constraint constraintName primary key (column [,column])
	 * 
	 * @param pkName
	 ...
	 * tableName alter column oldColumnName rename to newColumnName
	 * 
	 * @param from
	...
	/**
	 * Returns the SQL command to drop the specified table's primary key. alter
	 * table tableName drop primary key
	 * 
	 * @param pkName
	 ...
	 *      boolean, java.lang.String, java.util.Collection, java.lang.String,
	 *      java.lang.String,
	 ...
	 *      java.lang.String, String, java.lang.String[], boolean,
